...
#define MQTT_USER "quyet"           // <--- SỬA user
#define MQTT_PASS "1"               // <--- SỬA pass

// MAC Gateway (Node 2) - QUAN TRỌNG
const uint8_t mac_Node2[] = {0xD4, 0xE9, 0xF4, 0xA4, 0xF2, 0xB8}; 

#define BUZZER_PIN 15
#define BUTTON_PIN 4
#define LED_RED_PIN 19

// Biến trạng thái nội bộ để điều khiển LED
